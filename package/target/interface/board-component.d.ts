...
export declare type BoardComponent<Power, MilitaryBranch, State, UnitStatus, ProvinceStatus> = React.Component<BoardComponentProps<Power, MilitaryBranch, State, UnitStatus, ProvinceStatus>, {}>;
